...
/*
 * интерфейс IDrawer описывает реализацию.
 * класс Shape описывает нужный интерфейс. Конструктор базового класса содержит
 * объект реализации. Наследуемые от него классы используют объект реализации для
 * обеспечения методов своего интерфейса
 */
